...
@NgModule({
  ...
  providers: [
    ...
    ...[environment.interceptorConditions.caching ? { provide: HTTP_INTERCEPTORS, useClass: LoaderInterceptor, multi: true } : []],
    ...[environment.interceptorConditions.profiler ? { provide: HTTP_INTERCEPTORS, useClass: ProfilingInterceptor, multi: true } : []],
  ],
