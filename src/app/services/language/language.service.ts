...
import { setBengaliLanguage, setHindiLanguage } from 'src/app/pipes/language/language.pipe';
...
export class LanguageService {
  ...
  get languageState$() { return this.languageObserver.pipe(filter(el => el !== null)) }
